...
def selectionner_personnage():
    """
    Permet au joueur de sélectionner un personnage et retourne les informations.

    Returns:
    -------
    str : Le personnage choisi par le joueur.
    list[str] : La liste des personnages disponibles.
    """
    running = True
...
if __name__ == "__main__":
    perso_choisi, liste_personnages = selectionner_personnage()
    print(f"Personnage choisi : {perso_choisi}")
    print(f"Personnages disponibles : {liste_personnages}")

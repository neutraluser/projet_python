...
# List of competences
competences_feu = [
    Competence(nom="Boule de Feu", puissance=30, defense=10, cout_chakra=80, image_path="image_tech/Katon-Goukakyuu-no-Jutsu.jpg"),
    Competence(nom="Nuées Ardentes", puissance=80, defense=20, cout_chakra=25, image_path="image_tech/Haisekish__1.png"),
    Competence(nom="Katon_Pourpre", puissance=90, defense=10, cout_chakra=20, image_path="image_tech/Katon_-_Balsamine_Pourpre.png"),
    Competence(nom="Katon_Mekkyaku", puissance=80, defense=20, cout_chakra=25, image_path="image_tech/Katon_-_G_ka_Mekkyaku.png")
]
...
competences_foudre = [
    ...
    Competence(nom="orbe_raiton", puissance=85, defense=15, cout_chakra=20, image_path="image_tech/orbe_raiton.png"),
    Competence(nom="raiton_sasuke", puissance=95, defense=25, cout_chakra=30, image_path="image_tech/raiton_sasuke.png")
]

# Characters
personnage_feu = Personnage("Feu", 150, 200, competences_feu, "Feu","sprites/feu.webp")
